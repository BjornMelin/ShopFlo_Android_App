...
public class MainActivityCSR extends AppCompatActivity {
    ...
    /**
     * Method which contains all functions which occur upon creation of the
     * Customer Service Representative activity page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup the UI
        setContentView(R.layout.activity_main_csr);
         ...
         * it will redirect a user to the Order Activity page.
         */
        final Button ordersButton = findViewById(R.id.orders_csr);
