/**
 * Production Activity for Android Mobile Application
 * Allows for Production Management
 * @author Bjorn Melin
 */
...
public class ProductionActivity extends AppCompatActivity {
    ...
    /**
     * Method which contains all functions which occur upon creation of the Production activity page
