/**
 * Review Activity for Android Mobile Application
 * Used for Inspectors to Review Various Aspects of the Company
 * @author Bjorn Melin
 */
...
public class ReviewActivity extends AppCompatActivity {
    ...
    /**
     * Method which contains all functions which occur upon creation of the Review activity page
