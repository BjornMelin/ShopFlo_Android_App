/**
 * Order Activity for Android Mobile Application
 * Activity Used to Track Orders Made By Customers
 * @author Bjorn Melin
 */
...
public class OrderActivity extends AppCompatActivity {
    ...
    /**
     * Method which contains all functions which occur upon creation of the Order activity page
